...
| Archivo | Descripción |
|---|---|
| `paper.md` | Fuente del paper (Markdown, editable). ~2.988 palabras de cuerpo; 39 referencias APA 7. |
...
- Extensión: cuerpo en prosa (Introducción → Conclusión) ≈ 2.988 palabras, dentro
