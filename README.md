...
| Archivo | Descripción |
|---|---|
| `paper.md` | Fuente del paper (Markdown, editable). ~2.990 palabras de cuerpo; 46 referencias APA 7. |
...
- Extensión: cuerpo en prosa (Introducción → Conclusión) ≈ 2.990 palabras, dentro
