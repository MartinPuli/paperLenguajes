...
<style>
  ...
  *{box-sizing:border-box}
  ...
  ul.points li{position:relative; padding:11px 6px 11px 30px; font-size:21px; line-height:1.42; border-top:1px solid rgba(255,255,255,.05)}
  ...
  .blockcard .budget{display:inline-block; margin-top:16px; font-size:15px; font-weight:800; letter-spacing:1px; color:#aeb9c6; border:1px dashed #3a4654; padding:7px 16px; border-radius:999px}
  /* figure */
...
<body>
  <div class="top">
    ...
    <div class="help"><kbd>←</kbd> <kbd>→</kbd> navegar · <kbd>T</kbd> timer · <kbd>M</kbd> índice · <kbd>F</kbd> pantalla</div>
    <div class="timer" id="timer" title="Click para iniciar / pausar">20:00</div>
  </div>
...
const S = [
 ...
 {kind:'point', blk:1, who:'a', t:'La hipótesis del trabajo', b:[
   ...
   'Matiz honesto: la <b>base</b> (codificar rutinario) se automatiza y la <b>cima</b> (diseñar/decidir) se concentra → el oficio se <b>polariza</b>.']},
 ...
 {kind:'puente', blk:1, from:'a', to:'b', t:'«Esto ya pasó muchas veces antes, y nunca eliminó la profesión. Veamos qué está pasando hoy.»'},
 ...
 {kind:'point', blk:2, who:'b', t:'La IA mejoró muchísimo (con datos)', b:[
   'En un examen de problemas <b>reales</b> de programación pasó de <b>1 de cada 7</b> a <b>más de 9 de cada 10</b> en ~2 años.',
   'En Google y Microsoft, entre el <b>20 % y el 30 %</b> del código ya lo escribe la IA.']},
 {kind:'fig', blk:2, who:'b', img:'fig1', t:'La capacidad para programar se disparó', cap:'SWE-bench Verified — estado del arte. Hacia 2026 el examen se satura.', say:'Mostrá la curva, pero aclará: ese examen lo escribieron <b>ellos</b> y mide problemas <b>ya planteados</b>. Falta saber qué quería el cliente.'},
 ...
 {kind:'point', blk:2, who:'b', t:'El «problema del 70 %»', b:[
   'La IA hace rápido el <b>70 % fácil</b>; el <b>30 % difícil</b> (detalles, casos raros, seguridad) sigue siendo humano.',
   'Su código suele ser <b>inseguro</b>: cerca del <b>40 %</b> trae fallas de seguridad conocidas.',
   'Hasta «alucina» dependencias: recomienda paquetes que <b>no existen</b> ~1 de cada 5 veces.']},
 {kind:'fig', blk:2, who:'b', img:'fig6', t:'La IA acelera, pero la verificación sigue siendo humana', cap:'Pearce et al. (2022); Veracode (2025); Spracklen et al. (2025).', say:'Cerrá: velocidad <b>sin garantía</b>. Alguien tiene que revisar que esté bien.'},
 ...
 {kind:'point', blk:3, who:'a', t:'① No se puede verificar todo · Turing y Rice', b:[
   '<b>Indecidibilidad</b>: no existe ni puede existir un programa que revise, para <b>todo</b> programa, si cumple lo que debe hacer.',
   'Es el <b>problema de la parada</b>: ni siquiera se puede decidir en general si un programa termina.',
   '→ Siempre hará falta un <b>humano que valide y se haga responsable</b>. Y la IA <b>alucina de forma inevitable</b> (demostrado): no puede revisarse sola.']},
 {kind:'point', blk:3, who:'a', t:'② Hay problemas imposibles de resolver rápido · P vs NP', b:[
   ...
   'Alguien tiene que <b>decidir qué sacrificar</b>: ¿velocidad? ¿precisión? ¿recursos?',
   'Eso es un <b>criterio humano</b>, no un cálculo.']},
 {kind:'fig', blk:3, who:'a', img:'fig3', t:'③ Traducir lo humano a lo exacto · jerarquía de Chomsky', cap:'Los transformers ≈ clase TC⁰: por debajo de una computadora común.', say:'El lenguaje humano es <b>ambiguo</b>; el de la máquina, <b>exacto</b>. El ingeniero es el <b>traductor</b> entre esos dos mundos.'},
 ...
 {kind:'point', blk:4, who:'b', t:'Un dato esperanzador (y su matiz)', b:[
   ...
   'Contrapeso honesto (Acemoglu): si no se crea <b>tarea nueva</b>, la transición es <b>dura y desigual</b>.']},
 ...
 {kind:'quote', blk:4, who:'b', lead:'El ingeniero no desaparece: se transforma en <b>arquitecto, auditor y responsable</b> de los sistemas.',
   ...
   foot:'Y así se cierra el círculo con la pregunta del Bloque 1.'},
];
...
function render(){
  ...
  const bm = s.blk?CIRC[s.blk-1] : (i===0?'▶':'🏁');
  marker.textContent = i===S.length-1 ? '🏁' : bm;
  // dots de bloque
...
/* cronómetro 20:00 */
let secs=20*60, tHandle=null, running=false;
...
document.addEventListener('keydown',e=>{
  ...
  else if(e.key.toLowerCase()==='r'){clearInterval(tHandle);running=false;secs=20*60;tEl.textContent=fmt(secs);tEl.classList.remove('warn','over');}
